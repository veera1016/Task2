...
const index$1 = require("./index-VYnK9lGQ.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-gglYEdmt.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-gglYEdmt.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-uBHAnCtA.js.map
