...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/provider-upload-local": "4.25.0",
  "@strapi/utils": "4.25.0",
  axios: "1.6.0",
  "byte-size": "7.0.1",
  cropperjs: "1.6.0",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-tuQTf0X9.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-nbcu8DEv.js"));
        return component;
      },
...
//# sourceMappingURL=index-Dm9Zidgx.js.map
