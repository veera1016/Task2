...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-bpWYm_2K.mjs";
...
import { u as useWebhooks } from "./useWebhooks-s53jPlMa.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-VoPIQzKo.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-XGpPJ5IT.mjs.map
