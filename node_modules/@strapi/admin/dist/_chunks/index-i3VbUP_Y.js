...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await Promise.resolve().then(() => require("./Login-UyF88eV6.js"))).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await Promise.resolve().then(() => require("./constants-YUaeb0gI.js"))).FORMS,
    {
...
const AuthenticatedApp = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./AuthenticatedApp-E7CPlO3Y.js")).then((n) => n.AuthenticatedApp).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App$2 = ({ authLogo, menuLogo, showReleaseNotification, showTutorials }) => {
  const adminPermissions = useEnterprise(
    ADMIN_PERMISSIONS_CE,
    async () => (await Promise.resolve().then(() => require("./constants-lznAwdbt.js"))).ADMIN_PERMISSIONS_EE,
    {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-lznAwdbt.js"))).ROUTES_EE,
    {
      defaultValue: []
    }
  );
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await Promise.resolve().then(() => require("./InformationBoxEE-9-6EqSrY.js"))).InformationBoxEE
  );
  useOnce(() => {
...
const ListViewPage = ({
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-9DMXY5JG.js"))).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await Promise.resolve().then(() => require("./ReviewWorkflowsColumn-DxodWJ8B.js"));
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-9DMXY5JG.js"))).REVIEW_WORKFLOW_FILTERS,
    {
...
//# sourceMappingURL=index-i3VbUP_Y.js.map
