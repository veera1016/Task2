...
const CM = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-i3VbUP_Y.js")).then((n) => n.App).then((mod) => ({ default: mod.App }))
);
const HomePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./HomePage-PfMSC1GP.js")).then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./InstalledPluginsPage-H2i9UqYN.js")).then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./MarketplacePage-1lhwcGT1.js")).then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-i3VbUP_Y.js")).then((n) => n.NotFoundPage).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./ProfilePage-XhwfB7Qd.js")).then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./SettingsPage-xMo3mGPW.js")).then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-E7CPlO3Y.js.map
