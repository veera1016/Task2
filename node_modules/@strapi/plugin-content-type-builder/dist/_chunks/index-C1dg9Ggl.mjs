...
const ListView$1 = lazy(() => import("./ListView-BV5bLYe7.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-BV5bLYe7.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-C1dg9Ggl.mjs.map
