...
const index = require("./index-i3VbUP_Y.js");
const sortBy = require("lodash/sortBy");
const reactRedux = require("react-redux");
const AuthenticatedApp = require("./AuthenticatedApp-E7CPlO3Y.js");
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = index.useEnterprise(
    ceLinks,
    async () => (await Promise.resolve().then(() => require("./constants-lznAwdbt.js"))).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-XRSW0d3f.js"));
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-DGZ4_Kkb.js"));
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-9zcczy-7.js"));
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-HdjgNJD6.js"));
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-OsF1wwNv.js"));
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-zG-GEOfh.js"));
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-OMUV2ska.js")).then((n) => n.EditPage$1);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-yyG8GVrJ.js"));
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-e8PJTbMk.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-U4hcWBT9.js"));
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditViewPage-LzZNKZy0.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-l9qjLg1W.js"));
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-ZJt4pYI7.js"));
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditView-nc7Vklfc.js"));
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = index.useEnterprise(
    AdminSeatInfoCE,
    async () => (await Promise.resolve().then(() => require("./AdminSeatInfo-EzsrGxFf.js"))).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = index.useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-bbANe1l5.js"))).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-xMo3mGPW.js.map
